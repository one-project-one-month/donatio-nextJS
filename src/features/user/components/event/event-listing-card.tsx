...
function EventListingCard({ data, setFormData, setIsVisible }: {data: EventListingCardProps, setFormData: React.Dispatch<React.SetStateAction<DonateFormData>>, setIsVisible: React.Dispatch<React.SetStateAction<boolean>>}) {
