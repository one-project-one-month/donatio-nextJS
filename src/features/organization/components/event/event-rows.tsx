...
function EventRows({ data }: { data: EventRowsProps }) {
  return (
    <TableRow className="h-24 hover:bg-white">
      ...
      <TableCell className="min-w-[200px] text-center">{data.startDate}</TableCell>
      <TableCell className="min-w-[200px] text-center">{data.endDate}</TableCell>
      <TableCell className="min-w-[200px] text-center">{data.goalAmount} MMK</TableCell>
