...
function FormFileDefaultDropZone<T extends FieldValues>({
  form,
  name,
  label,
  type,
  ...
  useEffect(() => {
    if (defaultFiles.length > 0 && files.length === 0) {
      setFiles(defaultFiles);
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      form.setValue(name, defaultFiles as any);
    }
...
export default FormFileDefaultDropZone;
