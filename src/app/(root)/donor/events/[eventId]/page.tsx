...
import DonateFormPopUp, { DonateFormData } from "@/features/user/components/form/donate-form-popup";
...
export default function EventDetails() {
  ...
  <button className="min-w-[150px] px-5 py-2 text-primary border border-primary font-medium rounded-full hover:bg-primary/90 hover:text-white transition">
    See activities
  </button>

  <button
    className="min-w-[150px] px-5 py-2 bg-primary text-white font-medium rounded-full hover:bg-primary/80 transition"
